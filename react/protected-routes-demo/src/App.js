  ...
  return (
    <div className='container mt-2'>
      ...
      <Routes>
        ...
        <Route path='/dashboard' element={<Protected isSignedIn={isSignedIn}><Dashboard /></Protected>}></Route>
        <Route path='/products' element={<Protected isSignedIn={isSignedIn}><Products /></Protected>}></Route>
      </Routes>
      {isSignedIn ? (
